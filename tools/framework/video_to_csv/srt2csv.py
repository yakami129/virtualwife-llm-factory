...
if __name__ == '__main__':
    ...
    parser.add_argument('--srt_folder', default='srt_folder', type=str, required=True,
                        help="folder to output .csv files")
    parser.add_argument('--input_srt', default='input_srt', type=str, required=True,
                        help="path of input .srt/.ass file")
